...
function LeftPanel({
  ...
  return (
    <aside className="flex w-[280px] shrink-0 flex-col rounded-2xl border border-white/[0.04] bg-white/[0.015] backdrop-blur-none shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.03)]">
      {/* Panel heading */}
...
function RightPanel({ docs }: { docs: Doc[] }) {
  ...
  return (
    <section className="flex flex-1 flex-col overflow-hidden rounded-2xl border border-white/[0.04] bg-white/[0.01] backdrop-blur-none shadow-[0_8px_32px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.02)]">
      ...
      <div className="px-5 pb-4">
        <div className="flex items-center gap-3 rounded-xl border border-white/[0.07] bg-white/[0.03] px-4 py-2.5 backdrop-blur-none shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
    ...
    >
      <div
        className={cn(
          ...
          isUser
            ? "bg-violet-500/60 text-white backdrop-blur-none shadow-[0_4px_16px_rgba(139,92,246,0.2)]"
...
function TypingIndicator() {
  return (
    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="flex justify-start">
      <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] px-4 py-3 backdrop-blur-none">
